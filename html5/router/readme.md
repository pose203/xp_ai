...
- history 
  ...
  - hash + hashchange 有优点，但是有很大的缺点
    ...
    hash 不好理解
    不这样，传统后端路由一样
    http://127.0.0.1:5500/html5/router/history/index.html 首页
    http://127.0.0.1:5500/html5/router/history/about.html 关于
  - 怎样像后端路由，不刷新页面
